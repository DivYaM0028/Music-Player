...
def type():
        ...
        def open():
            ...
            for files in os.listdir(directory):
                if files.endswith (".mp3"):
                    ...
                    tkMessageBox.showerror('Error','Songs Not Found')
            def playlist():
                rtp=Tk()
                rtp.title("Playlist")
                rtp.minsize(200,50)
    ...
    #for index in range (0,count):  
        ...
        Button(rt,text=u"\U0001F507",height=2,width=5,bd=5,font='times 20 bold',command=mute,fg='white',bg='black').grid(row=3,column=0)
        Button(rt,text=u"\U0001F50A",height=2,width=5,bd=5,font='times 20 bold',command=vol,fg='white',bg='black').grid(row=3,column=5)
        Button(rt,text=u"\U0001F500",height=2,width=5,bd=5,font='times 20 bold',command=suffle,fg='white',bg='black').grid(row=3,column=1)
        Button(rt,text=u"\U0001F501",height=2,width=5,bd=5,font='times 20 bold',command=repeat,fg='white',bg='black').grid(row=3,column=4)
        rt.mainloop()    
#===========================================================================================================================================================================================================================================
    if(v1.get()==2):
        st=Tk()
    ...
    #for index in range (0,count):  
        ...
        Button(st,text=u"\U0001F507",height=2,width=5,bd=5,font='times 20 bold',command=mute,fg='white',bg='black').grid(row=3,column=0)
        Button(st,text=u"\U0001F50A",height=2,width=5,bd=5,font='times 20 bold',command=vol,fg='white',bg='black').grid(row=3,column=5)
        Button(st,text=u"\U0001F500",height=2,width=5,bd=5,font='times 20 bold',command=suffle,fg='white',bg='black').grid(row=3,column=1)
        Button(st,text=u"\U0001F501",height=2,width=5,bd=5,font='times 20 bold',command=repeat,fg='white',bg='black').grid(row=3,column=4)
        st.mainloop()        
#===========================================================================================================================================================================================================================================
    if(v1.get()==3):
        lt=Tk()
    ...
    #for index in range (0,count):  
        ...
        Button(lt,text=u"\U0001F507",height=2,width=5,bd=5,font='times 20 bold',command=mute,fg='white',bg='black').grid(row=3,column=0)
        Button(lt,text=u"\U0001F50A",height=2,width=5,bd=5,font='times 20 bold',command=vol,fg='white',bg='black').grid(row=3,column=5)
        Button(lt,text=u"\U0001F500",height=2,width=5,bd=5,font='times 20 bold',command=suffle,fg='white',bg='black').grid(row=3,column=1)
        Button(lt,text=u"\U0001F501",height=2,width=5,bd=5,font='times 20 bold',command=repeat,fg='white',bg='black').grid(row=3,column=4)
        lt.mainloop()
#===========================================================================================================================================================================================================================================
    if(v1.get()==4):
        edmt=Tk()
    ...
    #for index in range (0,count):  
        ...
        Button(edmt,text=u"\U0001F507",height=2,width=5,bd=5,font='times 20 bold',command=mute,fg='white',bg='black').grid(row=3,column=0)
        Button(edmt,text=u"\U0001F50A",height=2,width=5,bd=5,font='times 20 bold',command=vol,fg='white',bg='black').grid(row=3,column=5)
        Button(edmt,text=u"\U0001F500",height=2,width=5,bd=5,font='times 20 bold',command=suffle,fg='white',bg='black').grid(row=3,column=1)
        Button(edmt,text=u"\U0001F501",height=2,width=5,bd=5,font='times 20 bold',command=repeat,fg='white',bg='black').grid(row=3,column=4)
        edmt.mainloop()
...
def login():
    if(str(y.get())=="1228" and str(z.get())=="Divyam"):
        ...
        tkMessageBox.showinfo("Failed","Try Again")

#===========================================================================================================================================================================================================================================
def fun():
    if(v1.get()==0):
       tkMessageBox.showinfo("Wrong Choice","Please Select type of Song and Login Again")
    else:
        login()
